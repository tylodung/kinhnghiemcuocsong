...
const IndexPage = ({ data, pathContext }) => {
  ...
  return (
      ...
      <div className="home-template">
        ...
        <Header image='https://3.bp.blogspot.com/-uqgntUMekSk/VR5Yvo_60dI/AAAAAAAABh8/fLmnTWK9z2s/s1600/tai-hinh-nen-vu-tru-dep-cho-may-tinh-mien-phi-1.jpg' title="Kỷ Niệm Khó Phai" tagline="Ký ức tuổi thơ.." />
